...
| "`update-package.js` updates all dependencies"           | It only updates the 6 Angular packages in its `isStable` map: `@angular-devkit/build-angular`, `@angular-devkit/core`, `@angular-devkit/architect`, `@angular/compiler`, `@angular/compiler-cli`, `@angular/build`. Other deps are managed manually or via Renovate.                                                                                                                                                  |
