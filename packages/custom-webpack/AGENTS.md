...
**Breaks us if changed:** `@angular-devkit/build-angular` (builder functions + schema structure), `@angular-builders/common` (module loading), `webpack-merge`, `lodash`, `@angular-devkit/architect`
